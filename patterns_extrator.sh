...
java  -Xms512m -Xmx2048m -cp /usr/share/java/weka.jar weka.classifiers.lazy.IBk -K 1 -W 0 -A 'weka.core.neighboursearch.LinearNNSearch -A "weka.core.ManhattanDistance -R first-last"' -c 1 -t $filename -o >>  $result_filename
